...
/**
 * Paso de Encuesta de Perfil
 * Usa EvaluacionEmbedded para mostrar la evaluación directamente en el flujo lineal
 */
export function PerfilStep({ evaluationId, convocatoriaId, onNext, onBack, onEvaluationComplete, evaluationStatus }) {
  const handleEvaluationComplete = (result) => {
    ...
    onNext({ 
      evaluacionPerfilCompletada: true,
  ...
  const handleSkip = () => {
    ...
    onNext({ evaluacionPerfilCompletada: false })
  }
        ...
        <div className={styles.stepCard}>
          ...
          <div className={styles.actions}>
            ...
            <Button
              type="button"
              variant="primary"
              onClick={() => onNext({ evaluacionPerfilCompletada: true })}
    ...
    <div className={styles.stepContainer}>
      <div className={styles.stepCard}>
        <div className={styles.stepHeader}>
          ...
          <h2 className={styles.stepTitle}>Encuesta de Perfil</h2>
          <p className={styles.stepSubtitle}>
            Completa la encuesta de perfil para continuar
          </p>
        </div>
          ...
          {evaluationId || convocatoriaId ? (
            ...
            <>
              <div className={styles.warningBox}>
                <AlertCircle size={16} />
                <span>
                  No hay evaluación de perfil disponible para esta convocatoria.
