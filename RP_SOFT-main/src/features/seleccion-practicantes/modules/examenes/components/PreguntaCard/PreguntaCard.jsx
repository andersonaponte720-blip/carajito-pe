      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <div className={styles.metaInfo}>
            <span className={styles.pointsBadge}>{pregunta.points || 1} puntos</span>
            <span className={styles.typeBadge}>{pregunta.question_type === 'multiple_choice' ? 'Opción Múltiple' : pregunta.question_type === 'true_false' ? 'Verdadero/Falso' : 'Respuesta Corta'}</span>
          </div>
        </div>
